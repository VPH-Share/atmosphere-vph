...
ActiveRecord::Schema.define(version: 201702141400011) do
  ...
  create_table "atmosphere_user_appliance_types", force: :cascade do |t|
    t.integer "user_id"
    t.integer "appliance_type_id"
    t.string  "role"
  end
  ...
  create_table "atmosphere_users_security_policies", force: :cascade do |t|
    t.integer "user_id"
    t.integer "security_policy_id"
  end

  create_table "atmosphere_users_security_proxies", force: :cascade do |t|
    t.integer "user_id"
    t.integer "security_proxy_id"
  end
  ...
  create_table "security_policies", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["name"], name: "index_security_policies_on_name", unique: true, using: :btree
  end

  create_table "security_proxies", force: :cascade do |t|
    t.string   "name"
    t.text     "payload"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["name"], name: "index_security_proxies_on_name", unique: true, using: :btree
  end
