...
ActiveRecord::Schema.define(version: 20150218172347) do
  ...
  add_foreign_key "atmosphere_appliance_types", "security_proxies", name: "atmosphere_appliance_types_security_proxy_id_fk"
  ...
  add_foreign_key "atmosphere_dev_mode_property_sets", "security_proxies", name: "atmosphere_dev_mode_property_sets_security_proxy_id_fk"
